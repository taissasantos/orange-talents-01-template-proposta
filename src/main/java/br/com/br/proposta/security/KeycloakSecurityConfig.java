...
public class KeycloakSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET,"/api/cartoes/**").hasAuthority("SCOPE_proposta:read")
		.antMatchers(HttpMethod.POST,"/api/viagem/**").hasAuthority("SCOPE_proposta:write")
		.antMatchers(HttpMethod.GET,"/api/viagem/**").hasAuthority("SCOPE_proposta:read")
